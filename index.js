...
function getWinners(arr, callback) {
    return callback(arr).map(item => item['Home Team Goals'] > item['Away Team Goals'] ? item['Home Team Name'] : item['Away Team Name']);
};
...
function getAverageGoals(callback) {
    const averageGoals = callback.reduce(function(total, item) {
